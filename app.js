/* =========================================================
   ...
   - 両者Ready→3,2,1→自動開始（サーバ時刻基準で確実起動）
   - ランダム対戦：2回目以降も必ず動く（UI/タイマー完全初期化）
   - 部屋作成/入室は従来ルール準拠（players/p2 の最小更新）
   - スタンプ：既存 #btnStamp を確実にバインド
   - Barrier 判定の条件式バグ修正
   ========================================================= */
...
(async function main(){
  ...
  /* ====== スタンプ：UI & DB同期（既存 #btnStamp を確実に使用） ====== */
